...
//Application Title
define('APP_TITLE', 'Dandi File Manager');
...
$auth_users = array(
    'alfas' => '$2y$10$v06pJyEaX8bXq0shsjmViuur6RlWMuk6Z0EO/bDoKUvzx2lCG3XWS',//TRRD
    'admin' => '$2y$10$tMyL8HAyggyt6NpU5FardeyyE0kw6OcblWkk6TlRl9w84cmdtFHN6',//Z21
    'geo' => '$2y$10$68bTDJrgMPVeDjw1/lbGk.TEfk0FuD5vQVdb7eZiCEufMrox1GG2G'//12345
);
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex align-items-center mb-3">
                ...
                <?php if (!FM_READONLY): ?>
                    <a class="fw-bold" title="<?php echo lng('Delete') ?>"
                ...
                <?php endif; ?>
                <a class="fw-bold ms-2" href="<?php echo fm_enc($file_url) ?>" target="_blank"><i
                ...
                <?php } ?>
                <a class="fw-bold ms-2" href="?p=<?php echo urlencode(FM_PATH) ?>"><i
        ...
        <?php if (!FM_READONLY): ?>
            <div class="col-xs-12 col-sm-9">
                <ul class="list-inline footer-action">
                    ...
                    <li class="list-inline-item"><input type="submit" class="hidden" name="download" id="a-download"
                            value="Download"
                            onclick="return confirm('<?php echo lng('Download selected files and folders?'); ?>')">
                        <a href="javascript:document.getElementById('a-download').click();"
                            class="btn btn-small btn-outline-primary btn-2"><i class="fa fa-download"></i>
                            <?php echo lng('Download') ?> </a>
                    </li>
