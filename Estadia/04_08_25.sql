...
-- Volcando datos para la tabla estadia.alumnos: ~22 rows (aproximadamente)
INSERT INTO `alumnos` (`nombre`, `matricula`, `telefono`, `correo`, `carrera`, `CURP`, `ciudad`, `domicilio`, `edad`, `NSS`, `afiliacion`, `RH`, `donador`, `peso`, `talla`, `alergias`, `enfermedades`, `tratamientos`, `discapacidad`, `enCasoDeAccidente`, `genero`) VALUES
	...
	('María Hernández', 20230004, '555-876-5432', 'maria.hernandez@example.com', 'TIADSM', 'HEMA950404MDFRNL05', 'Puebla', 'Av. Juárez #321', 24, '12344', 'IMSS', 'O-', 'No', '65kg', '1.60m', 'Polen', 'Ninguna', 'Ninguno', 'Visual', 'Llamar a Juan Hernández 555-456-7890', 'H'),
	...
	('Laura Díaz', 20230008, '555-210-9876', 'laura.diaz@example.com', 'TIADSM', 'DILA990808MDFRZN08', 'Tijuana', 'Calle Reforma #404', 22, '222222222223', 'ISSSTE', 'O+', 'No', '60kg', '1.70m', 'Ninguna', 'Epilepsia', 'Anticonvulsivo', 'Ninguna', 'Llamar a Jorge Díaz 555-890-1234', 'H'),
...
-- Volcando datos para la tabla estadia.alumnovacuna: ~19 rows (aproximadamente)
...
-- Volcando datos para la tabla estadia.consultas: ~4 rows (aproximadamente)
INSERT INTO `consultas` (`id`, `nombre`, `fecha`, `diagnostico`) VALUES
	(1, 'domingo', '2025-06-25', 'sí'),
	(2, 'asdfghjk', '2025-07-01', 'sdfghjkl'),
	(3, 'prue a 2', '2025-07-08', 'Prueba\n'),
	(4, 'Tania', '2025-07-10', 'ASD');
...
-- Volcando datos para la tabla estadia.documento: ~8 rows (aproximadamente)
INSERT INTO `documento` (`id`, `nombre`, `alumno_mtr`) VALUES
	(1, 'Hoja_de_Rifa.pdf', 20230003),
	(2, 'memoria de estadias.pdf', 23005102),
	(3, 'Hoja_de_Rifa.pdf', 20230003),
	(4, '7_8 Informe quincenal.docx', 20230003),
	(5, 'Hoja_de_Rifa.pdf', 20230005),
	(6, 'Control de horas Estadias.pdf', 20230005),
	(7, '7_8 Informe quincenal.docx', 20230005),
	(8, 'Estadias Servicio medico.pdf', 20230005);
